...
const ReviewItem = ({ cart ,hendelRemovedFromCart}) => {
  const { img, name, price, shipping, id } = cart;
  return (
    <div className="flex items-center mt-6 border-2 p-2 rounded-md">
      ...
      <button onClick={()=> hendelRemovedFromCart(id)} className="h-[55px] w-[55px] rounded-[50%] bg-[#EB57574D]">
